...
<b>📈 search 도입 전후 비교</b>
- 테스트 환경 설정 : 동시 사용자 50명이 10초 동안 점진적으로 증가하고, 120초 동안 지속적으로 같은 API를 호출한다.
...
|--------------|------------|--------------|--------------|------------|---------|--------------------------|
| signin       | 119        | 106          | 202          | 22.45      | 0.00%   | 5.04439                  |
| keyword-es   | 87         | 7            | 734          | 68.33      | 0.00%   | 550.2111                 |
| keyword-jpa  | 15,335     | 479          | 35,728       | 5,728.52   | 0.50%   | 2.99763                  |

![image](https://github.com/user-attachments/assets/13e49018-3445-4b32-88e4-3639ce481ee8)


<b>🌟 성능 개선 요약</b>
| 구분               | JPA 검색 (도입 전)     | Elasticsearch 검색 (도입 후) | 증감량              | 증감율 / 배수                         |
|--------------------|-------------------------|-------------------------------|---------------------|---------------------------------------|
| 평균 응답 시간     | 15,335 ms               | 87 ms                         | –15,248 ms          | 약 **99.43% 감소**                   |
| 초당 처리량 (TPS)  | 2.99763 req/sec         | 550.2111 req/sec              | +547.21347 req/sec  | 약 **183.5배 증가 (≈ 18,276% ↑)**     |
| 표준편차           | 5,728.52                | 68.33                         | –5,660.19            | 응답 속도 **안정성 대폭 향상**        |
| 오류율             | 0.50%                   | 0.00%                         | –0.50%              | **오류 제거 → 신뢰성 확보**           |

- 평균 응답 시간: 15,335ms→ 87ms (약 99% 감소)
- 처리량: 2.99763 → 550.2111 req/sec (약 183배 증가)
- 표준편차 감소로 응답 시간의 안정성 확보
- 오류율 0% 유지로 신뢰성 확보
...
| 구분         | 평균 (ms) | 최소값 (ms) | 최대값 (ms) | 표준편차 | 오류 %  | 초당 요청수 (req/sec) | 표본수   |
|--------------|------------|--------------|--------------|-----------|---------|--------------------------|-----------|
| signin       | 116        | 99           | 215          | 25        | 0.00%   | 5.04898                  | 50        |
| payments-v2  | 226        | 16           | 1,412        | 138.70    | 0.00%   | 211.3821                 | 25,417    |
| payments-v1  | 208        | 11           | 2,212        | 148.23    | 0.00%   | 229.3559                 | 25,467    |

![image](https://github.com/user-attachments/assets/ac7e4955-0d57-41d7-a3c5-cbfdf0cad494)

| 구분         | 평균 (ms) | 최소값 (ms) | 최대값 (ms) | 표준편차 | 오류 %  | 초당 요청수 (req/sec) | 표본수   |
|--------------|------------|--------------|--------------|-----------|---------|--------------------------|-----------|
| signin       | 116        | 99           | 215          | 25        | 0.00%   | 5.04898                  | 50        |
| payments-v1  | 208        | 11           | 2,212        | 148.23    | 0.00%   | 229.3559                 | 27,575    |
| payments-v2  | 226        | 16           | 1,412        | 138.70    | 0.00%   | 211.3821                 | 25,417    |

![image](https://github.com/user-attachments/assets/2f790626-58f8-499a-9a17-f7ba54bdd693)

<b>🌟 성능 개선 요약</b>
| 구분               | payments-v2      | payments-v1      | 증감량           | 증감율 / 배수                  |
|--------------------|------------------|------------------|------------------|-------------------------------|
| 평균 응답 시간     | 226 ms           | 208 ms           | –18 ms           | 약 7.96% 감소                 |
| 초당 처리량 (TPS)  | 211.38 req/sec   | 229.36 req/sec   | +17.98 req/sec   | 약 1.085배 증가 (≈ 8.5% ↑)    |
