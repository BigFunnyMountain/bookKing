...
- 평균 응답 시간: 15,208ms → 830ms (약 94.5% 감소)
...
- 평균 응답 시간: 911ms → 1006ms (약 10.4% **느려짐**)
...
# 테스트 결과 문서
- [Auth 단위 테스트](./docs/report/Auth_단위_테스트.md)
- [User 단위 테스트](./docs/report/User_단위_테스트.md)
- [Book 단위 테스트](./docs/report/book_단위_테스트.md)
- [Elasticsearch 단위 테스트](./docs/report/elasticsearch_단위_테스트.md)
- [Keyword 단위 테스트](./docs/report/keyword_단위_테스트.md)
- [Order 단위 테스트](./docs/report/order_단위_테스트.md)
- [Payments 단위 테스트](./docs/report/payments_단위_테스트.md)
- [Review 단위 테스트](./docs/report/review_단위_테스트.md)
- [성능 테스트](./docs/report/성능테스트.md)
- [통합 테스트](./docs/report/통합테스트.md)
